      ...
      <div className="container mx-auto px-6 flex justify-between items-center">
        ...
        <div className="hidden md:flex gap-8 items-center text-sm font-bold tracking-widest">
          ...
          <a
            ...
            className="bg-orange-600 hover:bg-orange-700 text-white px-6 py-2 rounded-full font-bold transition-all transform hover:scale-105 shadow-[0_0_15px_rgba(234,88,12,0.3)] hover:shadow-[0_0_20px_rgba(234,88,12,0.5)]"
          >
            PEDIR AHORA
          </a>
        </div>
      ...
      {isOpen && (
        <div className="absolute top-full left-0 w-full bg-neutral-900 border-t border-neutral-800 p-6 flex flex-col gap-4 md:hidden animate-in slide-in-from-top-5">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="bg-orange-600 hover:bg-orange-700 text-white px-6 py-3 rounded-full font-bold transition-all transform hover:scale-105 text-center uppercase mt-4 shadow-[0_0_15px_rgba(234,88,12,0.3)] hover:shadow-[0_0_20px_rgba(234,88,12,0.5)]"
            onClick={() => setIsOpen(false)}
          >
            PEDIR AHORA
          </a>
